...
namespace WebPizzeria.Controllers
{
    public class ProductosController : Controller
    {
        ...
        public ProductosController(FinalPizzeriaContext context)
        {
            _context = context;
        }
        ...
        {
            var finalPizzeriaContext = _context.Productos.Include(p => p.IdCategoriaNavigation);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdProducto,IdCategoria,Codigo,Nombre,Descripcion,Precio,Stock,UsuarioRegistro,FechaRegistro,Estado")] Producto producto)
        {
