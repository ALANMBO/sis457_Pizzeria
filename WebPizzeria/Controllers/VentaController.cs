...
namespace WebPizzeria.Controllers
{
    public class VentaController : Controller
    {
        ...
        public VentaController(FinalPizzeriaContext context)
        {
            _context = context;
        }
        ...
        {
            var finalPizzeriaContext = _context.Venta.Include(v => v.IdClienteNavigation).Include(v => v.IdUsuarioNavigation);
